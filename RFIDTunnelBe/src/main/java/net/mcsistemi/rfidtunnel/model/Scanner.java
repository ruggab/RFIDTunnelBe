...
public class Scanner implements Runnable {
    ...
    public Scanner (String ip, int port, ScannerStreamRepository repository, TunnelLogRepository logRep) {
        this.ip = ip;
        this.port = port;
        ...
        try {
            ...
            while (running) {
                ...
                try {
                    ...
                    logger.info("Waiting for Scanner streams ... ");
                    Thread.sleep(1000);
                    in = connect();
                    continue;
                }
    ...
    public BufferedReader connect() {
        ...
        try {
            ...
            logger.error("Unable to get streams from Scanner");
        }
